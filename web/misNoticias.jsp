<%-- 
    Document   : misNoticias
    Created on : 4/12/2015, 09:18:26 AM
    Author     : Gerardo
--%>
        ...
        <div class="content-heading" style="background-image: none;">
            ...
            <div class="container">
               ...
               if(conexion.conecta() != 0)
                {
                    ...
                    sql = "SELECT c.id_noticia,concat(u.nombre, ' ',u.apellidos) as usuario,c.comentario,c.fecha FROM usuarios u, comentarios_noticias c WHERE u.id_usuario=c.id_autor_com and id_noticia IN(SELECT id_noticia FROM noticias n, usuarios u WHERE n.id_autor=u.id_usuario AND n.id_autor="+id_usuario+") ORDER BY id_noticia";
               }
               ...
               //Obtener comentarios de las noticias
                    ...
                    sql = "SELECT id_noticia,id_autor,concat(u.nombre, ' ',u. apellidos) as usuario,noticia,fecha FROM noticias n, usuarios u WHERE n.id_autor=u.id_usuario AND n.id_autor="+id_usuario+" ORDER BY fecha DESC;";
